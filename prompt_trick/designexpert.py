...
initial_content = 'You are a design expert. Generate 5 design solutions for ' + prompt
subseq_content = 'You are a design expert. Generate 5 more design solutions for ' + prompt 
...
for parameter in temp_topP:
    ...
    print(messages)
df = pd.DataFrame(lst)
df.to_csv('designexpert_towels.csv')
